...
function toggleDisplay(mode) {
  ...
  scaleLabel.textContent = showDegrees ? 'Diatonic Notes of the Major Scale (Ionian Mode)' : 'Diatonic - C Major Scale';
  octaveLabel.textContent = showDegrees ? '1st, 2nd and 3rd scale degrees from one octave' : '1st, 2nd and 3rd scale degrees from one octave';
